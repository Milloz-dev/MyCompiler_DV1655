...
{
       0,    36,    36,    43,    50,    54,    59,    66,    70,    75,
      81,    85,    90,   100,   106,   111,   116,   119,   122,   127,
     131,   135,   140,   145,   150,   155,   160,   165,   170,   175,
     180,   185,   189,   193,   197,   200,   203,   206,   209
};
#endif
...
{
       8,   -13,    14,   -36,     3,   -36,    23,    24,   -11,   -36,
      25,    11,    28,   -36,    22,    -5,    18,   -36,   -36,   -36,
     -36,     1,     4,     7,    -5,   -36,   -36,    16,    34,    20,
     -36,    35,    41,    42,    -5,    40,    45,   -14,    49,   -36,
      61,    -5,    65,    49,    63,   -36,    58,     2,   -36,   -36,
      -7,   -36,   -36,   -36,     2,     2,   -10,   -36,    36,    87,
      44,    77,    -5,     2,     2,    70,     2,     2,     2,     2,
       2,     2,     2,     2,     2,   -36,    -4,    57,    77,   -36,
      77,    77,    77,    77,    77,    85,    77,    77,    69,   -36,
     -36,    97,   -36
};
...
static const yytype_int8 yytable[] =
{
      ...
      53,    54,    41,    25,     7,     4,     8,    11,    10,    16,
      12,    19,    13,    19,    14,    60,    61,    23,    36,    55,
      56,    30,    27,    57,    77,    78,    28,    80,    81,    82,
      83,    84,    85,    86,    87,    88,    65,    31,    32,    33,
      34,    38,    35,    42,    75,    66,    67,    68,    69,    70,
      71,    72,    73,    66,    67,    68,    69,    70,    71,    72,
      73,    90,    45,    39,    47,    49,    66,    67,    68,    69,
      70,    71,    72,    73,    91,    79,    51,    74,    66,    67,
      68,    69,    70,    71,    72,    73,    66,    67,    68,    69,
      70,    71,    72,    73,    66,    67,    68,    69,    70,    92,
      72,    73,    76,    50
};
...
static const yytype_int8 yycheck[] =
{
      ...
      18,    19,    26,    22,    21,    38,     3,    38,     4,     7,
       5,    38,    21,    38,     6,    54,    55,    19,    62,    37,
      38,    25,    38,    41,    63,    64,    39,    66,    67,    68,
      69,    70,    71,    72,    73,    74,    20,    23,    38,    24,
      19,    21,    20,    14,    20,    29,    30,    31,    32,    33,
      34,    35,    36,    29,    30,    31,    32,    33,    34,    35,
      36,    24,    21,    38,    19,    22,    29,    30,    31,    32,
      33,    34,    35,    36,    25,    25,    38,    10,    29,    30,
      31,    32,    33,    34,    35,    36,    29,    30,    31,    32,
      33,    34,    35,    36,    29,    30,    31,    32,    33,    22,
      35,    36,    62,    45
};
...
#line 36 "parser.yy"
        ...
        if ((yyvsp[0].node)) root->children.push_back((yyvsp[0].node));
    }
...
#line 43 "parser.yy"
        ...
        (yyval.node)->children.push_back(new Node("MainArgType", "String[]", yylineno));
...
#line 90 "parser.yy"
        ...
        (yyval.node)->children.push_back((yyvsp[-11].node));
...
#line 127 "parser.yy"
        ...
        (yyval.node)->children.push_back(new Node("Param", (yyvsp[0].sval), yylineno));
    }
...
#line 180 "parser.yy"
        ...
        (yyval.node)->children.push_back(new Node("IDENTIFIER", (yyvsp[-2].sval), yylineno));
        (yyval.node)->children.push_back((yyvsp[0].node));
    }
...
#line 189 "parser.yy"
                                         {
        (yyval.node) = new Node("METHOD_CALL", (yyvsp[-3].sval), yylineno);
        (yyval.node)->children.push_back((yyvsp[-1].node));
    }
...
#line 193 "parser.yy"
                                              {
        (yyval.node) = new Node("ARRAY_ACCESS", (yyvsp[-3].sval), yylineno);
        (yyval.node)->children.push_back((yyvsp[-1].node));
    }
...
#line 197 "parser.yy"
                               {
        (yyval.node) = (yyvsp[-1].node); // Just return the inner expression
    }
