...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    LP = 261,                      // LP
    RP = 262,                      // RP
    SYSTEMDOTOUTDOTPRINTLN = 263,  // SYSTEMDOTOUTDOTPRINTLN
    INT = 264,                     // INT
    INTEGER = 265,                 // INTEGER
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_LP = 6,                                // LP
        S_RP = 7,                                // RP
        S_SYSTEMDOTOUTDOTPRINTLN = 8,            // SYSTEMDOTOUTDOTPRINTLN
        S_INT = 9,                               // INT
...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_SYSTEMDOTOUTDOTPRINTLN ()
      {
        return symbol_type (token::SYSTEMDOTOUTDOTPRINTLN);
      }
#else
      static
      symbol_type
